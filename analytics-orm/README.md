...
```shell
$ analytics-orm spark install-snowflake-jdbc-driver -h
usage: analytics-orm spark install-snowflake-jdbc-driver [-h]
...
example: "app/siddartham/snowflake-prod/password".
