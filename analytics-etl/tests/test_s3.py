...
from my_datastore_etl.concurrency import Concurrency
from my_datastore_etl.utilities import url_is_local
...
class TestS3(unittest.TestCase):
    ...
    def setUpClass(cls) -> None:
        ...
        run(
            [
                "docker-compose",
                "-f",
                str(TESTS_PATH.joinpath("s3-docker-compose.yml")),
                "--project-directory",
                str(TESTS_PATH),
                "up",
                "-d",
    ...
    def test_get_url(self) -> None:
        ...
        expected_url: str = (
            ...
            f"{self.file_system.root}{TEST1_TXT}"
        )
